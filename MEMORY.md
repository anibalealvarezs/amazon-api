...
- Purpose: This package operates within the Communication (SDKs) layer of the APIs Hub SaaS hierarchy, providing an interface to the Amazon API.
- Dependency stance: Consumes `anibalealvarezs/api-client-skeleton` and serves the `amazon-hub-driver`.
## Local working rules
...
## Current notes
- Amazon client layer should remain lightweight and source-facing.